...
* [Send weekly newsletter based on issue PR activity](https://github.com/jupyter-naas/awesome-notebooks/tree/master/GitHub/GitHub_Send_weekly_newsletter_based_on_issue_PR_activity.ipynb)
