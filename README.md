...
## About Naas
Naas is an open source all-in-one data platform that enable anyone with minimal technical knowledge in data to turn Jupyter Notebooks into powerful automation, analytical and AI engines thanks to <a href="https://docs.naas.ai/" target="_blank">low-code formulas</a>.<br>
...
The aim of this repository is to be the largest aggregator of production ready  <a href="https://jupyter.org" target="_blank">Jupyter Notebooks</a> templates.
